...
export default function MembershipVisual() {
  return (
    <div className="relative mx-auto w-full max-w-sm pb-10" aria-hidden="true">
      {/* Accent dot (top-left) */}
      <span className="absolute -left-6 top-[-10px] z-10 h-[22px] w-[22px] rounded-full bg-gradient-to-br from-brand-400 to-royal-600 shadow-md" />

      {/* Membership card */}
      <div className="rounded-[34px] border border-[#F6F4FF] bg-white p-8 h-[500px] w-[355px] shadow-[14px_41px_100px_rgba(49,89,211,0.12)]">
      ...
      <div className="absolute top-[70%] -left-10 flex w-[92%] items-center gap-3 rounded-[20px] bg-white p-3 [filter:drop-shadow(14px_13px_20px_rgba(135,129,245,0.18))]">
